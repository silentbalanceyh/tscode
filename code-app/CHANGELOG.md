...
### Improvements
* Added `routes.js` files for blueprints for convenient imports
...
### Improvements
* Renamed application entry point from `routes.js` -> `app.js` (clarifies intent and helps with coverage reports)
...
* `reducers/routes.js` now exports combined root reducer.
